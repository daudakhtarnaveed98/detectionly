                ...
                <div className="account-settings-card">
                    ...
                    <div className="reset-password-form">
                        <form>
                            ...
                            <button name="reset-password-button" id="reset-password-button">Reset Password</button>
                        </form>
                    </div>
                    ...
                    <div className="delete-account-form">
                        <form>
                            <label htmlFor="emailAddress">Enter Your Email Address:</label><br/>
                            <input type="email" name="emailAddress" id="emailAddress"/><br/>

                            <label htmlFor="password">Enter Your Password:</label><br/>
                            <input type="password" name="password" id="password"/><br/>

                            <button name="delete-account-button" id="delete-account-button">Delete Account</button>
                        </form>
                    </div>
                </div>
                <style jsx> {`
