...
class ForgotPassword extends React.Component {
  constructor(props) {
    ...
    this.state = {
      emailAddress: "",
      response: "Forgot password? Enter your email to reset.",
      status: false,
    };
  }
        ...
        <section className={styles.mainWrapper}>
          <section className={styles.signInForm}>
            ...
            <form>
              ...
              />
              <button onClick={this.handleEmailSending}>Reset Password</button>
  ...
  handleEmailSending = async (e) => {
    ...
    // Else proceed.
      ...
      const passwordResetEmailSendRequest = {
        url: "http://localhost:65000/forgot-password/" + emailAddress,
        method: "GET",
      };

      try {
        // Make API call.
        let emailSendingResponse = await axios(passwordResetEmailSendRequest);
